...
if($action =="change")
{
$query="update feedback set  comments='" . cleanQuery($_POST['comments']). "' where id=".$getid;
...
<table width="100%" border="0" cellpadding="0" cellspacing="0"   class="main-text" align="center">
          <tr>
            <td><h1>View Feedbacks</h1></td>
          </tr> 
         <tr>
            <td> <?php $query="SELECT * from feedback where id =". $getid." limit 1";
...
?></div>                                   
              <form action="fmessage.php?action=change&id=<?php echo $getid;?>" method="post" >   <table class="mgrey2" border="0" cellpadding="6" cellspacing="0" width="100%">
                <tbody>
                  <tr >
