...
?></div>
        ...
        <div class="clearfix sepH_b"></div>
                           ...
                           $sql="SELECT ".$tablename.".*,   `users`.`name` FROM `".$tablename."`  INNER JOIN `users` ON `".$tablename."`.`userid` = `users`.`id`  where ".$tablename.".vote=1 and ".$tablename.".userid!=0 and (".$tablename.".volunteer=1 or ".$tablename.".booth=1 or ".$tablename.".buzz=1 or ".$tablename.".`call`=1 or ".$tablename.".jansabha=1)";
		  ...
		  $cnt2=0;
                    ...
                    <tr>
                      ...
                      <td><?php echo $vote4aap[$row['booth']];?></td>
                      <td><?php if ($row['buzz']==0) {echo "No";} else if ($row['buzz']==1) {echo "1 Week";} else if ($row['buzz']==2) {echo "1 Wknd";} ?></td>
                      <td><?php echo $row['call'];?></td>
                      <td><?php echo $row['jansabha'];?></td>
