...
if($action=="change_pass")
  {
    $sql= "select password from users where id=".$_SESSION['userid'];		
        ...
        if(sha1(cleanQuery($_POST["old"]))!=$row['password']) 
                     ...
                     <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
                      <tr>
                        <td><div class="box-bg-rt">
                           ...
                           <form action = "change-password.php?action=change_pass" method="post" name="frm_change_m_pass" id="frm_change_m_pass"  >
                            <table border="0"  cellpadding="3" cellspacing="0" class="main-text"  align="center">
                              ...
                              <tr>
                                <td   align="right"><span class="red">* </span>Current password :&nbsp;</td>
                                <td width="170"  ><input type="password" name="old" id="old" class="input" maxlength="40" style="width:160px;" /></td>
                              </tr>
                              <tr>
