...
$.fn.countdown = function( method /*, options*/ ) {
	...
	var defaults = {
			date: new Date(),
			updateTime: 1E3,
			htmlTemplate: "<div class='cd-time'>Days</div><div class='cd-time'>Hours</div><div class='cd-time'>Minutes</div><div class='cd-time right'>Seconds</div><div class='stamp'><span><div class='line'></div>%{d}</span></div><div class='stamp'><span><div class='line'></div>%{h}</span></div><div class='stamp'><span><div class='line'></div>%{m}</span></div><div class='stamp right'><span><div class='line'></div>%{s}</span></div>",
			minus: false,
			onChange: null,
			onComplete: null,
			onResume: null,
		...
		timerFunc = function() {
			...
			percent = 100 - parseInt( (daysLeft / startDays ) * 100, 10);
