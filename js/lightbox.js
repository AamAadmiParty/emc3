...
{
if(document.getElementById("subscribeemail").value=="" || document.getElementById("subscribeemail").value=="Enter your email"){alert("Please enter email");document.getElementById("subscribeemail").focus();return false;}
if (!CheckEmail(document.getElementById("subscribeemail").value)) {alert('Invalid email id. Kindly provide a valid email id.'); document.getElementById("subscribeemail").focus(); return false}

var email2 = document.getElementById("subscribeemail").value;
nocache = Math.random();

if(email2!="")
{
http.open('get', 'subscribe.php?email='+email2+'&nocache = '+nocache);
...
hideDiv();
document.getElementById("subscribeemail").value="Enter your email";
// else if login is ok show a message: "Site added+ site URL".
document.getElementById('subscribe_status').innerHTML = response;
}
}